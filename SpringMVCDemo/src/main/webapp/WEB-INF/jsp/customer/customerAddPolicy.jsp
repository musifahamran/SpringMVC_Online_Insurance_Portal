			...
			<form class="form-detail" action="#" method="post" id="myform">
				<div class="form-left">
					...
					<select name="policyName">
						    <option value="0">Policy Name</option>
				...
				<div class="form-right">
					<h2>Policy Plans</h2>
					<div class="form-row">
						<select name="policyPlan">
						    <option value="0">Policy Plan</option>
						    <option value="life">Basic</option>
						    <option value="health">Premium</option>
						</select>
						<span class="select-btn">
						  	<i class="zmdi zmdi-chevron-down"></i>
						</span>	
